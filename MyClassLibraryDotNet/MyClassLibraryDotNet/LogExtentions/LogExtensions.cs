...
namespace NetExtentions
{
    ...
    public static class LogExtensions
    {
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<string, ILogger> _dictionary = new ConcurrentDictionary<string, ILogger>();
        ...
        {
            return null;
            //return _dictionary.GetOrAdd(objectName, Microsoft.Extensions.Logging.Logger.GetLoggerFor);
        }
    }
}