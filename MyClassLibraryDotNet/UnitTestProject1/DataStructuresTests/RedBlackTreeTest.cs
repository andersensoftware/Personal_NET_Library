...
namespace UnitTest.DataStructuresTests
{
    ...
    public static class RedBlackTreeTest
    {
        ...
        public static void DoTest()
        {
            ...
            // Assert count
            Assert.IsTrue(redBlackTree.Count == 11);

            // Assert existence and nonexistence of some items
            Assert.IsTrue(redBlackTree.Contains(1));
            Assert.IsTrue(redBlackTree.Contains(3));
           Assert.IsFalse(redBlackTree.Contains(999));
            ...
            // Assert count
            Assert.IsTrue(redBlackTree.Count == 8);

            // Assert nonexistence of previously existing items
           Assert.IsFalse(redBlackTree.Contains(1));
           Assert.IsFalse(redBlackTree.Contains(3));
           ...
           Assert.IsFalse(redBlackTree.Contains(oldRootVal));
