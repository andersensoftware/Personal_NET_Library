...
namespace UnitTest.DataStructuresTests
{
    ...
    public static class GraphsDirectedDenseGraphTest
    {
        ...
        public static void DoTest()
        {
            ...
            Assert.IsTrue(graph.BreadthFirstWalk("a").SequenceEqual(new string[] { "a", "z", "s", "x", "d", "c", "f", "v" }));

            // DFS from A
            // Walk the graph using DFS from A:
            Assert.IsTrue(graph.DepthFirstWalk("a").SequenceEqual(new string[] { "a", "s", "x", "c", "v", "f", "d", "z" }));

            // BFS from F
            // Walk the graph using BFS from F:
            Assert.IsTrue(graph.BreadthFirstWalk("f").SequenceEqual(new string[] { "f", "c", "d", "v", "s", "x", "a", "z" }));


            // DFS from F
            // Walk the graph using DFS from F:
            Assert.IsTrue(graph.DepthFirstWalk("f").SequenceEqual(new string[] { "f", "c", "v", "d", "s", "x", "a", "z" }));
