...
namespace DataStructuresTests
{
    ...
    public static class ArrayListTest
    {
        ...
        public static void DoTest()
        {
            ...
            Assert.IsTrue(allNumbersGreatorThanNineHundK.Count > 0, "Count check failed!");

            long nineHundK = arrayList.Find(item => item == 900000);

            var indexIfNineHundK = arrayList.FindIndex(item => item == nineHundK);
            Assert.IsTrue(indexIfNineHundK != -1, "Wrong index!");
            ...
            Assert.IsTrue(allNines.Count == 6, "Wrong result!");

            bool doesMillionExist = arrayList.Exists(item => item == 1000000);
           Assert.IsFalse(doesMillionExist, "Wrong result!");

            bool doesEightsExists = arrayList.Contains(88888);
            Assert.IsTrue(doesEightsExists, "Wrong result!");
            ...
            Assert.IsTrue(arrayList.Count == 32, "Wrong array size.");
        }
    }
}
