...
namespace UnitTest.DataStructuresTests
{
    ...
    public static class AVLTreeTest
    {
        ...
        public static void DoTest()
        {
            ...
            Assert.IsTrue(avlTreeHeight < bsTreeHeight, "Wrong heights. AVL Tree must be shorted than BS Tree.");
        ...
        private static void AssertCase_1(AVLTree<int> avlTree)
        {
            ...
            Assert.IsTrue(avlRoot.Value == 5, "Wrong root.");
            Assert.IsTrue(avlRoot.LeftChild.Value == 4, "Wrong left child.");
            Assert.IsTrue(avlRoot.RightChild.Value == 7, "Wrong right child.");
        ...
        private static void AssertCase_2(AVLTree<int> avlTree)
        {
            var avlRoot = avlTree.Root;
            Assert.IsTrue(avlRoot.Value == 5, "Wrong root.");
            Assert.IsTrue(avlRoot.Height == 2, "Wrong root height!");
            Assert.IsTrue(avlRoot.LeftChild.Value == 2, "Wrong left child from root.");
            Assert.IsTrue(avlRoot.RightChild.Value == 7, "Wrong right child from root.");
            Assert.IsTrue(avlRoot.LeftChild.LeftChild.Value == 1, "Wrong value at {root->left->left}.");
            Assert.IsTrue(avlRoot.LeftChild.RightChild.Value == 4, "Wrong value at {root->left->right}.");
        ...
        private static void AssertCase_3(AVLTree<int> avlTree)
        {
            var avlRoot = avlTree.Root;
            Assert.IsTrue(avlRoot.Height == 2, "Wrong root height!");
            Assert.IsTrue(avlRoot.Value == 4, "Wrong root.");
            Assert.IsTrue(avlRoot.LeftChild.Value == 2, "Wrong left child from root.");
            Assert.IsTrue(avlRoot.RightChild.Value == 5, "Wrong right child from root.");
            Assert.IsTrue(avlRoot.LeftChild.LeftChild.Value == 1, "Wrong value at {root->left->left}.");
            Assert.IsTrue(avlRoot.LeftChild.RightChild.Value == 3, "Wrong value at {root->left->right}.");
            Assert.IsTrue(avlRoot.RightChild.RightChild.Value == 7, "Wrong value at {root->right->right}.");
        ...
        private static void AssertCase_4(AVLTree<int> avlTree)
        {
            ...
            Assert.IsTrue(avlRoot.Value == 4, "Wrong root.");
            Assert.IsTrue(avlRoot.LeftChild.Value == 2, "Wrong left child from root.");
            Assert.IsTrue(avlRoot.RightChild.Value == 6, "Wrong right child from root.");
            Assert.IsTrue(avlRoot.LeftChild.LeftChild.Value == 1, "Wrong value at {root->left->left}.");
            Assert.IsTrue(avlRoot.LeftChild.RightChild.Value == 3, "Wrong value at {root->left->right}.");
            Assert.IsTrue(avlRoot.RightChild.LeftChild.Value == 5, "Wrong value at {root->right->left}.");
            Assert.IsTrue(avlRoot.RightChild.RightChild.Value == 7, "Wrong value at {root->right->right}.");
        ...
        private static void AssertCase_5(AVLTree<int> avlTree)
        {
            var avlRoot = avlTree.Root;
            Assert.IsTrue(avlRoot.Height == 2, "Wrong root height!");
            Assert.IsTrue(avlRoot.Value == 6, "Wrong root.");
            Assert.IsTrue(avlRoot.LeftChild.Value == 2, "Wrong left child from root.");
            Assert.IsTrue(avlRoot.RightChild.Value == 7, "Wrong right child from root.");
            Assert.IsTrue(avlRoot.LeftChild.LeftChild.Value == 1, "Wrong value at {root->left->left}.");
            Assert.IsTrue(avlRoot.LeftChild.RightChild.Value == 3, "Wrong value at {root->left->right}.");
            Assert.IsTrue(avlRoot.RightChild.LeftChild.Value == 5, "Wrong value at {root->right->left}.");
            Assert.IsTrue(avlRoot.RightChild.RightChild == null, "Wrong value at {root->right->right}.");
