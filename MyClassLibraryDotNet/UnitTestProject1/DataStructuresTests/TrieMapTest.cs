...
namespace UnitTest.DataStructuresTests
{
    ...
    public static class TrieMapTest
    {
        ...
        public static void DoTest()
        {
           ...
           Assert.IsFalse(trieMap.ContainsWord(prefix_howTo));

            // Search for prefix
            Assert.IsTrue(trieMap.ContainsPrefix(prefix_howTo));

            // Search for a prefix using a word
            Assert.IsTrue(trieMap.ContainsPrefix(word_howToSand));
           ...
           Assert.IsFalse(trieMap.ContainsWord("acto"));
            ...
            foreach (var word in allWords)
                Assert.IsTrue(listOfActWords.Contains(word) || listOfHow.Contains(word));
        }
    }
}
